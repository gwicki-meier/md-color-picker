...
(function (global, factory) {
	...
	GradientCanvas.prototype.setMarkerCenter = function (x, y) {
	  ...
	  angular.element(this.marker).css({
	    'left': x + 'px'
	  });
	  angular.element(this.marker).css({
	    'top': y + 'px'
	  ...
	  var fn = angular.bind(this, function (e) {
	    switch (this.type) {
	      case 'hue':
	        ...
	        this.$scope.$broadcast('mdColorPicker:spectrumHueChange', {
	          hue: hue
	        });
	        break;
	      case 'alpha':
	...
	GradientCanvas.prototype.setColor = function (color) {
	  ...
	  this.$scope.$apply();
	  this.$scope.$broadcast('mdColorPicker:spectrumColorChange', {
	    color: color
	  });
	};
	...
	angular.module('mdColorPicker', []).run(['$templateCache', function ($templateCache) {
	  ...
	  return {
	    ...
	    controller: ["$scope", "$element", "$attrs", function controller($scope, $element, $attrs) {
	      ...
	      angular.element(container[0].querySelector('.md-color-picker-result'));
	    ...
	    link: function link(scope, element, attrs) {
	      element[0].getElementsByTagName('md-tab');
	      /*
